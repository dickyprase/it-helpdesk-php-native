                ...
                <div class="col-md-12 col-xl-4">
                    ...
                    <div class="card shadow p-3 mb-4 bg-body rounded">
                        ...
                        <form>
                            ...
                            <div class="mb-3">
                                <label for="#" class="form-label">Tingkat Prioritas :</label>
                            ...
                            <div class="text-end">
                                <button type="submit" class="btn btn-success">Buat Divisi</button>
                            </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" id="btnHapus" class="btn btn-danger" style="font-size: 15px;">Hapus</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
